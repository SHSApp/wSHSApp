...
namespace wSHSApp.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("NewPassword", ErrorMessage = "По-внимательнее! Пароли не совпадают.")]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Не могу найти юзера '{_userManager.GetUserId(User)}'.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Пароль успешно изменен. По-внимательнее!");
            StatusMessage = "Пароль успешно изменен. По-внимательнее!";
